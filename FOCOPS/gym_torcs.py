...
class TorcsEnv:
    ...
    def step(self, u, DISTRACTED, noise, episode_timesteps, PREVSTEER, PREVACCEL, PREV_AGENT_STEER, PREV_AGENT_ACCEL):
        AgentInteract = True
        ...
        # print(self.get_obs())
        return self.get_obs(), reward, episode_terminate, obs['distRaced'], obs['trackPos'], DISTRACTED, this_action["accel"],this_action["steer"], accel, steer, savedaction, PREVSTEER, PREVACCEL, PREV_AGENT_STEER, PREV_AGENT_ACCEL, info
    ...
    def make_observaton(self, raw_obs):
        return np.concatenate(
            ...
            #     np.array([0], dtype=np.float32).reshape(1),
            #     np.array([0], dtype=np.float32).reshape(1)
